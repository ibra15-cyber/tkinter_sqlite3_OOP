...
database = Database() #creating obj of our class
window=Tk() #creating obj of tkinter class
...
# view = database.view() #this will be wrong bc it is expecting a fn and not a variable
...
b7=Button(window, text="Commit", width=12, command=commit_command)
